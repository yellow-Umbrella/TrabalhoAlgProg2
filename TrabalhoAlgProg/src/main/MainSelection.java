...
public class MainSelection {
	...
	public static void main(String[] args) throws IOException {
		...
		SelectionSort selection = new SelectionSort(); //Objeto com o método de ordenação SelectionSort.

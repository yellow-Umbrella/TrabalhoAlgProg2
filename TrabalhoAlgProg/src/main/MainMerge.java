...
public class MainMerge {
	...
	public static void main(String[] args) throws IOException {
		...
		MergeSort merge = new MergeSort(); //Objeto com o método de ordenação MergeSort.
		Long time1, time2; //Tempo antes e depois da ordenação.
		long[] swapComp; //Contadores de trocas e comparações.
		////////////////////////////////////////////////////////////
		
		// Lista recebe os 1000 números do arquivo 1000.txt, pega o tempo antes da ordenação, ordena pelo MergeSort

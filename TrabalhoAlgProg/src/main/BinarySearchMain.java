...
public class BinarySearchMain {
	...
	public static void main(String[] args) throws IOException {
		...
		time1 = 0;
		time2 = 0;
		for(Node no = listB1.getHead(); no.getNext() != null; no = no.getNext()) {
		...
		time1 = 0;
		time2 = 0;
		for(Node no = listB5.getHead(); no.getNext() != null; no = no.getNext()) {
			time1 += System.nanoTime();
		...
		time1 = 0;
		time2 = 0;
		for(Node no = listB10.getHead(); no.getNext() != null; no = no.getNext()) {
			time1 += System.nanoTime();
		...
		time1 = 0;
		time2 = 0;
		for(Node no = listB20.getHead(); no.getNext() != null; no = no.getNext()) {
			time1 += System.nanoTime();
		...
		time1 = 0;
		time2 = 0;
		for(Node no = listB50.getHead(); no.getNext() != null; no = no.getNext()) {
			time1 += System.nanoTime();
		...
		time1 = 0;
		time2 = 0;
		for(Node no = listB100.getHead(); no.getNext() != null; no = no.getNext()) {
			time1 += System.nanoTime();

...
public class MainInsertionO {
	...
	public static void main(String[] args) throws IOException {
		...
		InsertionSortO inserction = new InsertionSortO(); //Objeto com o método de ordenação InsertionSortOptimizado.
		long time1, time2; //Tempo antes e depois da ordenação.
		long[] swapComp; //Contadores de trocas e comparações.
		////////////////////////////////////////////////////////////
		
		// Lista recebe os 1000 números do arquivo 1000.txt, pega o tempo antes da ordenação, ordena pelo InsertionSort Optimizado
